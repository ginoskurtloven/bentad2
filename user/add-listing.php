		...
		<div class="col-md-9">
			...
			<?php
				if(isset($_POST['add_post'])) {
					...
					$listing = new Listing();
					$listing->add_listing($item_title,$item_category,$item_price,$item_condition,$item_location,$item_desc,$item_contactinfo,$status,$user_id); //insert data from the form
